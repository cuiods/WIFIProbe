...
public class HDFSTool {
    ...
    /**从HDFS上读取文件*/
    private static DataInputStream readFromHdfs(String fileName) throws FileNotFoundException,IOException {
    ...
    /**从HDFS上删除文件*/
    private static void deleteFromHdfs(String fileName) throws FileNotFoundException,IOException {
        String dst = NodeConfig.HDFS_PATH + fileName;
        Configuration conf = new Configuration();
        FileSystem fs = FileSystem.get(URI.create(dst), conf);
    ...
    /**遍历HDFS上的文件和目录*/
    private static List<String> getDirectoryFromHdfs(String directory) throws FileNotFoundException,IOException {
