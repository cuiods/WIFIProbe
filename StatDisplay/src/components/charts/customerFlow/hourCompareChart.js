...
const HourCompareChart = ({data}) => (
  <Container>
    <BarChart data = {data} margin={{
      ...
      <Bar dataKey="intAndOutStore" name="店铺来往人数" stackId="a" fill="#BA55D3" />
      ...
      <Bar dataKey="stayInStorePre" name="店铺停留人数预测" stackId="a" fill="#ffc658" fillOpacity={0.4}/>
      <Bar dataKey="intAndOutStorePre" name="店铺来往人数预测" stackId="a" fill="#BA55D3" fillOpacity={0.4}/>
